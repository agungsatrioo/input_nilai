...
import 'package:input_nilai/app/ui/pages/up/page_up_details.dart';
...
class UPHomePageDosen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _UPHomePageDosenState();
  }
}

class _UPHomePageDosenState extends State<UPHomePageDosen>
                    ...
                    switch (snapshot.connectionState) {
                      ...
                      default:
                        if (snapshot.hasError) {
                          ...
                          return center_text(
                              "Gagal memuat daftar mahasiswa Ujian Proposal.");
